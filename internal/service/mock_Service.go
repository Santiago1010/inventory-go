...
import (
	...
	models "github.com/Santiago1010/inventory-go/internal/models"
...
// ReigsterUser provides a mock function with given fields: ctx, email, name, password
func (_m *MockService) ReigsterUser(ctx context.Context, email string, name string, password string) error {
